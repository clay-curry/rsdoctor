...
(function () {
  ...
  var a = {},
    b = function (c) {
      ...
      for (
        a[this.id] = this,
          this.settings = new b.classes.configurable(
            b.settings,
            j.settings || {},
          ),
      ...
      for (f = j.middlewares || [], d = 0, e = f.length; e > d; d++)
        this.middlewares.push(
          'string' == typeof f[d] ? b.middlewares[f[d]] : f[d],
        );
  ...
  if (
    ((b.prototype.addCamera = function (a) {
      var c,
        d = this;
      if (!arguments.length) {
      ...
      return (
        (c = new b.classes.camera(a, this.graph, this.settings)),
        (this.cameras[a] = c),
    ...
    (b.prototype.addRenderer = function (a) {
      ...
      if (
        ((d = 'function' == typeof g.type ? g.type : b.renderers[g.type]),
        (d = d || b.renderers.def),
        (e =
          'camera' in g
            ? g.camera instanceof b.classes.camera
              ? g.camera
      ...
      return (
        ...
        (this.renderers[c] = f),
        Object.defineProperty(f, 'id', { value: c }),
        f.bind &&
          f.bind(
            [
              'click',
    ...
    (b.prototype.refresh = function () {
      var a,
        ...
        g,
        h = 0;
      for (e = this.middlewares || [], a = 0, c = e.length; c > a; a++)
        e[a].call(
          this,
          0 === a ? '' : 'tmp' + h + ':',
          a === c - 1 ? 'ready:' : 'tmp' + ++h + ':',
      ...
      for (d in this.cameras)
        (f = this.cameras[d]),
          f.settings('autoRescale') &&
          this.renderersPerCamera[f.id] &&
          this.renderersPerCamera[f.id].length
            ? b.middlewares.rescale.call(
                this,
                e.length ? 'ready:' : '',
                f.readPrefix,
                {
        ...
        if (this.renderers[e[a]].process)
          if (this.settings('skipErrors'))
            try {
              ...
              console.log(
                'Warning: The renderer "' + e[a] + '" crashed on ".process()"',
              );
            }
    ...
    function b(a, c) {
      ...
      if (arguments.length)
        if (1 === arguments.length && Object(arguments[0]) === arguments[0])
          ...
          for (d in f)
            (e = f[d]), C[e] || (C[e] = []), C[e].push({ handler: c });
        }
    }
    function c(a, b) {
      var c,
    ...
    (a.prototype.bind = function (a, b) {
      ...
      if (1 === arguments.length && 'object' == typeof arguments[0])
        ...
        for (c in e)
          (d = e[c]),
            d &&
              (this._handlers[d] || (this._handlers[d] = []),
              this._handlers[d].push({ handler: b }));
      }
      return this;
    }),
        ...
        if (b)
          for (c in g) {
            if (((f = g[c]), this._handlers[f])) {
              e = [];
              for (d in this._handlers[f])
                this._handlers[f][d].handler !== b &&
                  e.push(this._handlers[f][d]);
              this._handlers[f] = e;
            }
            this._handlers[f] &&
              0 === this._handlers[f].length &&
              delete this._handlers[f];
          }
      ...
      (a.prototype.dispatchEvent = function (a, b) {
        ...
        for (c in i)
          if (((g = i[c]), this._handlers[g])) {
            (f = h.getEvent(g, b)), (e = []);
            for (d in this._handlers[g])
              this._handlers[g][d].handler(f),
                this._handlers[g][d].one || e.push(this._handlers[g][d]);
            this._handlers[g] = e;
          }
        return this;
      }),
    ...
    (i.addMethod = function (a, b) {
      ...
      i.addMethod('addEdge', function (a) {
        ...
        return (
          ...
          this.inNeighborsIndex[a.target][a.source] ||
            (this.inNeighborsIndex[a.target][a.source] = Object.create(null)),
          (this.inNeighborsIndex[a.target][a.source][a.id] = a),
          this.outNeighborsIndex[a.source][a.target] ||
            (this.outNeighborsIndex[a.source][a.target] = Object.create(null)),
          (this.outNeighborsIndex[a.source][a.target][a.id] = a),
          this.allNeighborsIndex[a.source][a.target] ||
            (this.allNeighborsIndex[a.source][a.target] = Object.create(null)),
          (this.allNeighborsIndex[a.source][a.target][a.id] = a),
          this.allNeighborsIndex[a.target][a.source] ||
            (this.allNeighborsIndex[a.target][a.source] = Object.create(null)),
  ...
  function () {
    ...
    sigma.utils.pkg('sigma.captors'),
      (sigma.captors.mouse = function (a, b, c) {
        ...
        function i(a) {
          var b, c, d, e;
          return w('mouseEnabled')
            ? ((d = 1 / w('doubleClickZoomingRatio')),
              (e = Math.max(w('zoomMin'), Math.min(w('zoomMax'), v.ratio * d))),
              (d = e / v.ratio),
              e !== v.ratio &&
                ((c = sigma.misc.animation.killAll(v)),
                (b = v.cameraPosition(
                  sigma.utils.getX(a) - a.target.width / 2,
                  sigma.utils.getY(a) - a.target.height / 2,
                  !0,
                )),
                sigma.misc.animation.camera(
                  v,
                  { x: b.x * (1 - d) + v.x, y: b.y * (1 - d) + v.y, ratio: e },
                  {
            ...
            switch (
              ...
              case 2:
                (F = d(E[0])),
                  ...
                  (f = G.y),
                  (I = C.cameraPosition(
                    (q + s) / 2 - a.target.width / 2,
                    (r + t) / 2 - a.target.height / 2,
                    !0,
                  )),
                  (B = C.cameraPosition(
                    (b + c) / 2 - a.target.width / 2,
                    (e + f) / 2 - a.target.height / 2,
                    !0,
                  )),
        ...
        function h(a) {
          ...
          return a.touches && 1 === a.touches.length && D('touchEnabled')
            ? ((y = !0),
              ...
              (e = f / C.ratio),
              f !== C.ratio &&
                ((c = sigma.misc.animation.killAll(C)),
                (b = d(a.touches[0])),
                (b = C.cameraPosition(
                  b.x - a.target.width / 2,
                  b.y - a.target.height / 2,
                  !0,
                )),
                sigma.misc.animation.camera(
                  C,
                  { x: b.x * (1 - e) + C.x, y: b.y * (1 - e) + C.y, ratio: f },
                  {
                    easing: c ? 'quadraticOut' : 'quadraticInOut',
    ...
    sigma.utils.pkg('sigma.renderers'),
      ...
      (sigma.renderers.canvas.prototype.render = function (b) {
        ...
        var c,
          ...
          t = this.settings.embedObjects(b, { prefix: this.options.prefix });
        ...
        for (
          ...
          o[c[d].id] = c[d];
        if (q) {
          for (c = p.edges(), d = 0, f = c.length; f > d; d++)
            (g = c[d]),
              (o[g.source] || o[g.target]) && this.edgesOnScreen.push(g);
          if (this.settings(b, 'batchEdgesDrawing'))
            (h = 'edges_' + this.conradId),
              (n = t('canvasEdgesBatchSize')),
              (l = this.edgesOnScreen),
              (f = l.length),
              (k = 0),
              (i = Math.min(l.length, k + n)),
              (j = function () {
                for (m = sigma.canvas.edges, d = k; i > d; d++)
                  (g = l[d]),
                    (m[g.type] || m.def)(
                      g,
                      p.nodes(g.source),
        ...
        if (r)
          for (
            ...
            (m[c[d].type] || m.def)(c[d], this.contexts.nodes, t);
        if (s)
          for (
            ...
            (m[c[d].type] || m.def)(c[d], this.contexts.labels, t);
      ...
      (sigma.renderers.canvas.prototype.clear = function () {
        ...
        for (a in this.domElements)
          'CANVAS' === this.domElements[a].tagName &&
            (this.domElements[a].width = this.domElements[a].width);
        return this;
      }),
  ...
  function (a) {
    ...
    sigma.utils.pkg('sigma.renderers'),
      ...
      (sigma.renderers.webgl.prototype.process = function () {
        ...
        for (a = f.edges(), b = 0, c = a.length; c > b; b++)
        ...
        for (a = f.nodes(), b = 0, c = a.length; c > b; b++)
          ...
          for (
            ...
            this.edgeFloatArrays[d].array ||
              (this.edgeFloatArrays[d].array = new Float32Array(
                a.length * e.POINTS * e.ATTRIBUTES,
              )),
              e.addEdge(
                a[b],
                f.nodes(a[b].source),
                f.nodes(a[b].target),
                this.edgeFloatArrays[d].array,
                b * e.POINTS * e.ATTRIBUTES,
                g.prefix,
                this.settings,
              );
        for (d in this.nodeFloatArrays)
          for (
            e = sigma.webgl.nodes[d],
      ...
      (sigma.renderers.webgl.prototype.render = function (b) {
                  ...
                  (d = function () {
                    return (
                      this.edgePrograms[a[b]] ||
                        (this.edgePrograms[a[b]] = h.initProgram(k)),
                      f > g &&
                      ...
                      f >= e.length / h.ATTRIBUTES && b === a.length - 1
                        ? (delete this.jobs[c], !1)
                        : (f >= e.length / h.ATTRIBUTES
                            ? (b++,
                              (e = this.edgeFloatArrays[a[b]].array),
                              (h = sigma.webgl.edges[a[b]]),
                              (g = 0),
        ...
        if (n)
          for (
            ...
            (sigma.canvas.labels[c[d].type] || sigma.canvas.labels.def)(
              c[d],
            ...
            (this.domElements[d].style.width = b + 'px'),
              ...
              'canvas' === this.domElements[d].tagName.toLowerCase() &&
                (this.contexts[d] && this.contexts[d].scale
                  ? (this.domElements[d].setAttribute('width', b + 'px'),
                    this.domElements[d].setAttribute('height', c + 'px'))
  ...
  function () {
    ...
    sigma.utils.pkg('sigma.misc'),
      (sigma.misc.bindEvents = function (a) {
            ...
            for (c = 0, e = r.length; e > c; c++)
              if (
                ...
                o > j - l &&
                  ...
                  p > k - l &&
                  k + l > p &&
                  Math.sqrt(Math.pow(o - j, 2) + Math.pow(p - k, 2)) < l)
              ) {
        ...
        function c(a) {
          function c(a) {
            h.settings('eventsEnabled') &&
              (h.dispatchEvent('click', a.data),
              (f = b(a)),
              f.length
                ? (h.dispatchEvent('clickNode', { node: f[0] }),
                  h.dispatchEvent('clickNodes', { node: f }))
          ...
          function d() {
            if (h.settings('eventsEnabled')) {
              ...
              for (g = {}, b = 0, c = d.length; c > b; b++)
                h.dispatchEvent('outNode', { node: d[b] });
              d.length && h.dispatchEvent('outNodes', { nodes: d });
            }
          }
          function e(a) {
            if (h.settings('eventsEnabled')) {
              ...
              for (c = 0; l > c; c++)
                (e = f[c]),
                  (k[e.id] = e),
                  g[e.id] || (j.push(e), (g[e.id] = e));
              for (d in g) k[d] || (i.push(g[d]), delete g[d]);
              for (c = 0, l = j.length; l > c; c++)
                h.dispatchEvent('overNode', { node: j[c] });
              for (c = 0, l = i.length; l > c; c++)
                h.dispatchEvent('outNode', { node: i[c] });
              j.length && h.dispatchEvent('overNodes', { nodes: j }),
                i.length && h.dispatchEvent('outNodes', { nodes: i });
            }
          }
          var f,
            g = {};
    ...
    sigma.utils.pkg('sigma.misc'),
      (sigma.misc.drawHovers = function (a) {
        function b() {
          ...
          var b,
            e = sigma.canvas.hovers,
            f = c.settings.embedObjects({ prefix: a });
          if (f('enableHovering'))
