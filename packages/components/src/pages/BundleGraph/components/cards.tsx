...
const AssetCardContainer: React.FC<{
  ...
  return (
    <StatisticCard
      ...
      value={
        datas.map((e, i) => (
          <AssetCard {...e} key={i} tagBgColor={bgColor?.tagBgColor} />
        ))[idx]
      }
      boxProps={{
...
export const BundleCards: React.FC<{
  ...
  return (
    <Row
      gutter={
        windowWith > 1200 && windowWith < 1400
          ? [Size.BasePadding * 2, Size.BasePadding]
          : [Size.BasePadding, Size.BasePadding]
      }
      wrap
